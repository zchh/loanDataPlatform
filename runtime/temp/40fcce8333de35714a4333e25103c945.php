                ...
                <form class="form-horizontal" method="post" action="">
                    <div class="box-body">
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input name="title" type="text" class="form-control" id="inputEmail3" placeholder="请在这里输入标题">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-10">
                                <textarea name="describe" id="myEditor" style="width:100%;height:380px;"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="box-footer">
                            ...
                            <button type="button" class="btn btn-info pull-right" id="addInformation">确定发布</button>
                        </div>
                        <!-- /.box-footer -->
                </form>
            </div>
