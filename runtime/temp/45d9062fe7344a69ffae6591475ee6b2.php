...
<div class="box box-success">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-xs-4">
                <input name="tel" value="<?php echo $tel; ?>" type="text" class="form-control">
            </div>
            ...
            <div class="col-xs-4">
                <input name="loan_amount" value="<?php echo $loan_amount; ?>" type="text" class="form-control">
            </div>
            ...
            <div class="col-xs-4">
                <input name="credit" value="<?php echo $credit; ?>" type="text" class="form-control">
            </div>
            <div class="col-xs-2">
                <label class="pull-right">有无公积金</label>
            </div>
            <div class="col-xs-4">
                <input name="have_provident" value="<?php echo $have_provident; ?>" type="text" class="form-control">
            </div>
            ...
            <div class="col-xs-4">
                <input name="have_social_security" value="<?php echo $have_social_security; ?>" type="text" class="form-control">
            </div>
            <div class="col-xs-2">
                <label class="pull-right">有无工作</label>
            </div>
            <div class="col-xs-4">
                <input name="have_job" value="<?php echo $have_job; ?>" type="text" class="form-control">
            </div>
            ...
            <div class="col-xs-4">
                <input name="age" value="<?php echo $age; ?>" type="text" class="form-control">
            </div>
            <div class="col-xs-2">
                <label class="pull-right">QQ号码</label>
            </div>
            <div class="col-xs-4">
                <input name="qq" value="<?php echo $qq; ?>" type="text" class="form-control">
            </div>
            ...
            <div class="col-xs-4">
                <input name="wx_number" value="<?php echo $wx_number; ?>" type="text" class="form-control">
            </div>
            <div class="col-xs-2">
                <label class="pull-right">申请时间</label>
            </div>
            <div class="col-xs-4">
                <input name="add_time" value="<?php echo $add_time; ?>" type="text" class="form-control">
            </div>
            ...
            <div class="col-xs-4">
                <input name="tel_status" value="<?php echo $tel_status; ?>" type="text" class="form-control">
            </div>
            <div class="col-xs-6">
            </div>
            ...
            <div class="col-xs-4">
                <textarea name="remark" style="width: 100%;height: 100%;"><?php echo $remark; ?></textarea>
            </div>
            <div class="col-xs-10">
                <button type="button" class="btn btn-default pull-right">取消</button>
                <button type="button" class="btn btn-primary pull-right" id="editCustomer">确认修改</button>
            </div>
        </div>
...
<script>
    ...
    $("#editCustomer").click(function () {
        $.ajax({
            type: "post",
            url: '/admin/editCustomer/'+$("[name='customer_id']").val(),
            data: {
                'name': $("[name='name']").val(),
                'tel': $("[name='tel']").val(),
                'loan_amount': $("[name='loan_amount']").val(),
                'credit': $("[name='credit']").val(),
                'have_provident': $("[name='have_provident']").val(),
                'have_social_security': $("[name='have_social_security']").val(),
                'have_job': $("[name='have_job']").val(),
                'age': $("[name='age']").val(),
                'qq': $("[name='qq']").val(),
                'wx_number': $("[name='wx_number']").val(),
                'add_time': $("[name='add_time']").val(),
                'tel_status': $("[name='tel_status']").val(),
